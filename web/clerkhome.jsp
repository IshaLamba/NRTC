	...
	<div id="templatemo_header">
        ...
        <div id="templatemo_menu">
            ...
            <ul>
                ...
                <li><a href="SearchTrain.jsp">destinations</a></li>
                <li><a href="SeatAvail.jsp">weather</a></li>
			...
			<h3> Manipulations </h3>
			        <ul>
			            <li><a href="./Route.jsp"> Train Routes </a></li>
                                    <li><a href="./Fare.jsp"> Add meals</a></li>
                                    <li><a href="./Fare.jsp"> Remove meals </a></li>
                                   
			       </ul>
		<h3> Reports </h3>
        <ul>
            <li><a href="./adminusers.jsp"> View Users  </a></li>
            <li><a href="./adminbook.jsp"> View daily Bookings  </a></li>
            <li><a href="./admincancel.jsp"> View Cancellations  </a></li>
            <li><a href="./adminfeed.jsp"> View FeedBacks  </a></li>
            <li><a href="./Fare.jsp"> View full history </a></li>
        </ul>
<h3> Others...</h3>
        <ul>
            <li><a href="./adminusers.jsp"> New bookings </a></li>
            <li><a href="./adminbook.jsp"> cancel Bookings  </a></li>
            <li><a href="./admincancel.jsp"> View trains  </a></li>
        </ul>
		</div>
...
%>
    ...
    <div id="templatemo_footer">
       ...
       Copyright &copy; 2015   
<p>NRTC, Designed and Hosted by Isha Lamba.</p>
