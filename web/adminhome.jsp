			...
			<h3> Manipulations </h3>
			        <ul>
			            ...
			            <li><a href="./TrainInfo.jsp"> New Train  </a></li>
                                    <li><a href="./Fare.jsp"> Delete trains </a></li>
                                    <li><a href="./Fare.jsp"> New hotels </a></li>
                                    <li><a href="./Fare.jsp"> Delete hotels </a></li>
                                    <li><a href="./Fare.jsp"> Add clerk window </a></li>
                                    <li><a href="./Fare.jsp"> Remove clerk window </a></li>
			       </ul>
		<h3> Reports </h3>
        <ul>
